...
public class UserResource {
	...
	@PostMapping // recebe metodo post do http
	public ResponseEntity<User> insert(@RequestBody User obj){ // recebe json que vai ser desserializado como um objeto user
